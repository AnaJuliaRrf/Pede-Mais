...
4. Demonstrar fluxo WhatsApp até `pronto_para_criar_pedido` e confirmação final com criação de pedido.
...
7. Mostrar evidência da suite cumulativa executada 2x consecutivas com 100% verde.
